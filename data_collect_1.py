...
data4 = get_tv_data(symbol4, exchange4, interval4, n_bars4)  # For XRP
data5 = get_tv_data(symbol5, exchange5, interval5, n_bars5)  # For XRPUSDT pair
...
#Drop the last row
new = main_data.drop(main_data.index[-1])

# Save the main_data DataFrame to a CSV file
new.to_csv('main_data.csv', index=True)